...
class TextPredictionModel:
    ...
    def from_artefacts(cls, artefacts_path: str):
        ...
        # TODO: CODE HERE
        # load params
        open_params = open(f"{artefacts_path}/params.json")
        print(open_params)
        params = json.load(open_params)

        # TODO: CODE HERE
        # load labels_to_index
        open_index = open(f"{artefacts_path}/labels_index.json")
        print(open_index)
        labels_to_index = json.load(open_index)
    ...
    def predict(self, text_list, top_k=5):
        ...
        tag_pred = self.model.predict(embedded)
